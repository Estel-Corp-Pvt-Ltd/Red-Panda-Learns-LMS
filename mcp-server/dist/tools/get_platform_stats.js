...
export async function getPlatformStats() {
    ...
    const [usersSnap, coursesSnap, enrollmentsSnap, ordersSnap, bundlesSnap, quizzesSnap, couponsSnap, announcementsSnap,] = await Promise.all([
    ...
    const [activeEnrollments, completedEnrollments, droppedEnrollments, publishedCourses, draftCourses, archivedCourses, completedOrders, pendingOrders, activeStudents, teachers, instructors, admins,] = await Promise.all([
...
//# sourceMappingURL=get_platform_stats.js.map