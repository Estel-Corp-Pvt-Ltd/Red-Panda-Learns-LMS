...
export async function updateCoupon(params) {
    ...
    if (params.code !== undefined)
        updates.code = params.code.toUpperCase();
    ...
    if (params.expiryDate !== undefined)
        updates.expiryDate = new Date(params.expiryDate);
    if (params.usageLimit !== undefined)
        updates.usageLimit = params.usageLimit;
    if (params.status !== undefined)
        updates.status = params.status;
    if (params.linkedCourseIds !== undefined)
        updates.linkedCourseIds = params.linkedCourseIds;
    if (params.linkedBundleIds !== undefined)
        updates.linkedBundleIds = params.linkedBundleIds;
...
//# sourceMappingURL=update_coupon.js.map