...
export async function updateCourse(params) {
    ...
    if (params.instructorId !== undefined) {
        updateData.instructorId = params.instructorId;
        updatedFields.push("instructorId");
    }
    if (params.instructorName !== undefined) {
        updateData.instructorName = params.instructorName;
        updatedFields.push("instructorName");
    }
    if (params.pricingModel !== undefined) {
        updateData.pricingModel = params.pricingModel;
        updatedFields.push("pricingModel");
    }
    if (params.regularPrice !== undefined) {
        updateData.regularPrice = params.regularPrice;
        updatedFields.push("regularPrice");
    }
    if (params.salePrice !== undefined) {
        updateData.salePrice = params.salePrice;
    ...
    if (params.categoryIds !== undefined) {
        updateData.categoryIds = params.categoryIds;
        updatedFields.push("categoryIds");
    }
    if (params.targetAudienceIds !== undefined) {
        updateData.targetAudienceIds = params.targetAudienceIds;
        updatedFields.push("targetAudienceIds");
    }
    ...
    if (params.isEnrollmentPaused !== undefined) {
        updateData.isEnrollmentPaused = params.isEnrollmentPaused;
        updatedFields.push("isEnrollmentPaused");
    }
    if (params.isMailSendingEnabled !== undefined) {
        updateData.isMailSendingEnabled = params.isMailSendingEnabled;
        updatedFields.push("isMailSendingEnabled");
    }
    if (params.isCertificateEnabled !== undefined) {
        updateData.isCertificateEnabled = params.isCertificateEnabled;
        updatedFields.push("isCertificateEnabled");
    }
    if (params.isCourseCompletionEnabled !== undefined) {
        updateData.isCourseCompletionEnabled = params.isCourseCompletionEnabled;
        updatedFields.push("isCourseCompletionEnabled");
    }
    if (params.isForumEnabled !== undefined) {
        updateData.isForumEnabled = params.isForumEnabled;
        updatedFields.push("isForumEnabled");
    }
    if (params.isWelcomeMessageEnabled !== undefined) {
        updateData.isWelcomeMessageEnabled = params.isWelcomeMessageEnabled;
        updatedFields.push("isWelcomeMessageEnabled");
    }
    if (params.customCertificateName !== undefined) {
        updateData.customCertificateName = params.customCertificateName;
        updatedFields.push("customCertificateName");
    }
    if (params.certificateTemplateId !== undefined) {
        updateData.certificateTemplateId = params.certificateTemplateId;
        updatedFields.push("certificateTemplateId");
    }
