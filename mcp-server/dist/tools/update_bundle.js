...
export async function updateBundle(params) {
    ...
    if (params.salePrice !== undefined)
        updates.salePrice = params.salePrice;
    if (params.regularPrice !== undefined)
        updates.regularPrice = params.regularPrice;
    if (params.pricingModel !== undefined)
        updates.pricingModel = params.pricingModel;
    ...
    if (params.instructorId !== undefined)
        updates.instructorId = params.instructorId;
    if (params.instructorName !== undefined)
        updates.instructorName = params.instructorName;
...
//# sourceMappingURL=update_bundle.js.map