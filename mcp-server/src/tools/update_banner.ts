...
export async function updateBanner(params: {
  ...
  if (params.ctaTitle !== undefined) updates.ctaTitle = params.ctaTitle;
  if (params.ctaLink !== undefined) updates.ctaLink = params.ctaLink;
  if (params.imageUrl !== undefined) updates.imageUrl = params.imageUrl;
  if (params.gradientColors !== undefined) updates.gradientColors = params.gradientColors;
  if (params.courseIds !== undefined) updates.courseIds = params.courseIds;
  if (params.status !== undefined) updates.status = params.status;
  if (params.showToAllUsers !== undefined) updates.showToAllUsers = params.showToAllUsers;
  if (params.showInLandingPage !== undefined) updates.showInLandingPage = params.showInLandingPage;
