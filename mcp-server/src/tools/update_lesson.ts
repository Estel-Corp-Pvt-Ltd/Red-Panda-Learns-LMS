...
export async function updateLesson(params: {
  ...
  if (params.type !== undefined) { updateData.type = params.type; updatedFields.push("type"); }
  if (params.description !== undefined) { updateData.description = params.description; updatedFields.push("description"); }
  if (params.embedUrl !== undefined) { updateData.embedUrl = params.embedUrl; updatedFields.push("embedUrl"); }
