...
export async function createAnnouncement(params: {
  ...
  if (params.courseId) announcement.courseId = params.courseId;
  if (params.organizationId) announcement.organizationId = params.organizationId;
  if (params.targetClass) announcement.targetClass = params.targetClass;
  if (params.targetDivision) announcement.targetDivision = params.targetDivision;
