...
const formatMoney = (amount: number, cur: Currency) =>
  new Intl.NumberFormat(undefined, { style: 'currency', currency: cur }).format(amount);
...
return (
  <div className="min-h-screen bg-background dark:bg-[#0e0f11] flex flex-col">
    ...
    {/* Mobile sticky CTA (attention-drawing, always on top) */}
    <div className="sticky top-0 z-40 lg:hidden bg-white/95 dark:bg-[#0e0f11]/95 border-b border-blue-100 dark:border-zinc-800 backdrop-blur">
      <div className="px-4 py-3 flex items-center justify-between gap-3">
        <div className="flex flex-col">
          <span className="text-xs text-gray-500 dark:text-gray-400">Pay and enroll</span>
            ...
            <Card className="xl:col-span-1 bg-white dark:bg-zinc-900 border border-blue-100 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden">
              <CardHeader className="border-b border-blue-100 dark:border-zinc-800 flex flex-row justify-between items-center">
                ...
                <Button
                  ...
                  className="border-blue-300 dark:border-blue-700 hover:bg-blue-50 dark:hover:bg-blue-950/30 text-blue-600 dark:text-blue-400"
                >
            ...
            <Card className="xl:col-span-2 bg-white dark:bg-zinc-900 border border-blue-100 dark:border-zinc-800 rounded-xl shadow-sm">
              ...
              <CardContent>
                ...
                <div className="space-y-2">
                  ...
                  {couponMessage && (
                    <p className={`text-sm ${isCouponValid ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                      {couponMessage}
                    </p>
                  )}
                </div>
                        ...
                        <div className="flex gap-3">
                          <div
                            className={`w-4 h-4 mt-1 rounded-full border-2 ${
                              isSelected ? "bg-blue-600 border-blue-600" : "border-gray-400 dark:border-[#555]"
                            }`}
                          />
                          <div>
                            <div className="flex items-center gap-2 font-medium">
                              <img
                                src={provider.id === "RAZORPAY" ? "/razorpay-icon.svg" : "/paypal-icon.svg"}
                                className="h-5"
                                alt={provider.id}
                              />
                            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <Label htmlFor="agree" className="text-sm leading-snug">
                  I agree to the{" "}
                  <Link to="/terms" className="underline text-blue-600 dark:text-blue-400">Terms & Conditions</Link>,{" "}
                  <Link to="/privacy" className="underline text-blue-600 dark:text-blue-400">Privacy Policy</Link>, and{" "}
                  <Link to="/refund-policy" className="underline text-blue-600 dark:text-blue-400">Refund Policy</Link>.
                </Label>
              </div>
