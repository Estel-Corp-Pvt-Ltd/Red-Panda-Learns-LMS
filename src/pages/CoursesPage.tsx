...
const isEnrolledInBundle = async (bundleId: string): Promise<boolean> => {
  const enrolled = enrollments.some(e => e.targetId === bundleId);
  console.log(">>> enrolled?", { bundleId, enrolled, enrollments });
                  ...
                  >
                    {bundles.map((bundle, index) => (
                      <BundleWrapper
                        ...
                        index={index}
                        user={user}
                        isEnrolledInBundle={isEnrolledInBundle}
                        viewMode={viewMode}
