          ...
          <CardContent className="space-y-6 text-sm sm:text-base leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                or software) on RedPanda Learns’s web site for personal, non-commercial transitory
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                ...
                <li>Attempt to decompile or reverse engineer any software from RedPanda Learns</li>
                <li>Remove any copyright or proprietary notations</li>
                <li>Transfer the materials to another person or mirror them on any other server</li>
              </ul>
              <p className="mt-2">
                This license shall automatically terminate if you violate any of these restrictions
                and may be terminated by RedPanda Learns at any time. Upon termination, you must
            ...
            <section>
              ...
              <p>
                The materials on RedPanda Learns’s web site are provided “as is”. RedPanda Learns
                ...
                other rights. Further, RedPanda Learns does not warrant the accuracy, likely
                results, or reliability of use of the materials.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                In no event shall RedPanda Learns or its suppliers be liable for any damages
                (including, without limitation, damages for loss of data or profit, or due to
                business interruption,) arising out of the use or inability to use RedPanda Learns’s
                site, even if a representative has been notified of potential damage. Some
                jurisdictions do not allow limitations on warranties, so these limitations may not
                apply to you.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The materials on RedPanda Learns’s site may include errors (technical,
                typographical, or photographic). RedPanda Learns does not guarantee materials are
                accurate, complete, or current, and may update content at any time without notice.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Teachers using the platform are not allowed to solicit business from
                students/parents or encourage them to leave RedPanda Learns. Any violation will
                result in forfeiture of the account balance.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                RedPanda Learns has not reviewed all linked sites and is not responsible for the
                contents of any such site. Inclusion of a link does not imply endorsement. Use of
                linked web sites is at your own risk.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                RedPanda Learns may revise these terms of use at any time without notice. By using
