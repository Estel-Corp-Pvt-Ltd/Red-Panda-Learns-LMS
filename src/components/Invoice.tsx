      ...
      <div ref={invoiceRef}>
        <div className="mx-auto print:max-w-none border border-gray-300">
          <div className="bg-white p-6 print:p-0">
                ...
                <tbody>
                  {invoiceData.items.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td className="border border-gray-300 p-1 text-center print:border print:p-1">{item.igstPercentage}%</td>
                      <td className="border border-gray-300 p-1 text-right print:border print:p-1">{formatCurrency(item.igstAmount)}</td>
                ...
                <table className="w-full text-sm print:text-sm">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="total-value text-right text-gray-900 py-1 pl-2 print:py-1 print:pl-2">{formatCurrency(invoiceData.totalTax)}</td>
                    </tr>
            ...
            {/* Signature Section */}
            <div className="signature-section flex justify-between items-end border-t border-gray-300 pt-4 mt-4 print:flex print:justify-between print:border-t print:pt-4 print:mt-4">
