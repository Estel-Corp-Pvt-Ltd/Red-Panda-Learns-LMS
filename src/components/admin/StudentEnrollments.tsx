    ...
    <AdminLayout>
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage and view all student course enrollments</p>
        </div>
                ...
                <div className="flex items-center gap-3">
                  <span className="text-sm text-gray-700">
                    ...
                    {hasMixedStatusSelection() && (
                      <span className="text-orange-600 ml-2">(Mixed statuses)</span>
                    )}
                  </span>
                  ...
                  {canActivateSelected() && (
                    ...
                    >
                      {bulkActionLoading ? 'Activating...' : 'Activate Selected'}
                    </button>
                  )}
                  ...
                  {canDeactivateSelected() && (
                    ...
                    >
                      {bulkActionLoading ? 'Deactivating...' : 'Deactivate Selected'}
                    </button>
                  )}
                  ...
                  <div className="flex-1 flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md ${!enrollments.hasPreviousPage || currentPage === 1 || loading
                      ...
                      <button
                        ...
                        className={`relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md ${!enrollments.hasNextPage
                          ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                          : 'bg-white text-gray-700 hover:bg-gray-50'
                          }`}
                      >
