  ...
  const teamMembers = [
    {
      ...
      image:
        "https://www.RedPanda Learns.com/lovable-uploads/6bb7f718-7a63-42f1-9839-3a8b15bdacec.png",
    ...
    },
    {
      ...
      image:
        "https://www.RedPanda Learns.com/lovable-uploads/93d168b8-3f90-4854-8ccb-1e39ae2a3b4c.png",
    ...
    },
    {
      ...
      education: "PhD, MIT | B.Tech, IIT Madras",
      image:
        "https://www.RedPanda Learns.com/lovable-uploads/1cb0b8c2-ad88-4e95-879b-b0cae6ae9ecb.png",
    ...
    <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Team RedPanda Learns</h2>
        ...
        <div className="max-w-5xl mx-auto mb-12">
          <Card className="p-8 bg-gradient-to-br from-brand-light to-white/50 dark:from-brand-light dark:to-card/50 border-brand-fuchsia/20">
            <div className="text-center">
              <img
                src="https://www.RedPanda Learns.com/lovable-uploads/8dc8e40c-8c8b-48c1-a187-0ee0ef7a4a75.png"
                alt="Team RedPanda Learns at MIT"
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <Button
                variant="outline"
                size="sm"
                className="border-brand-fuchsia/30 text-brand-fuchsia hover:bg-brand-fuchsia hover:text-white"
              >
                <a href={member.Linkedin_link} target="blank">
                  LinkedIn Profile
                </a>
              </Button>
            </Card>
